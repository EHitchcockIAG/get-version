...
const fs_1 = __nccwpck_require__(7147);
const logging = __importStar(__nccwpck_require__(6679));
const lodash_1 = __importDefault(__nccwpck_require__(250));
function getVersion({ packagePath = 'package.json', jsonPath = 'version' }) {
    return __awaiter(this, void 0, void 0, function* () {
        logging.info('Using', packagePath, 'as package directory');
        let pkg;
        try {
            pkg = (0, fs_1.readFileSync)(packagePath, {
                encoding: 'utf-8'
            });
        }
        catch (e) {
        ...
        let version;
        try {
            version = lodash_1.default.get(JSON.parse(pkg), jsonPath);
        }
        catch (e) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(8149), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.printVersion = exports.info = exports.success = exports.warn = exports.error = void 0;
var STATUS_SYMBOLS;
...
function printVersion(version) {
    success('Version:', version === null || version === void 0 ? void 0 : version.version);
    success('Major Version:', version === null || version === void 0 ? void 0 : version.major);
    success('Minor Version:', version === null || version === void 0 ? void 0 : version.minor);
    success('Patch Version:', version === null || version === void 0 ? void 0 : version.patch);
}
...
const get_version_1 = __importDefault(__nccwpck_require__(3262));
const { packagePath, jsonPath } = (0, helpers_1.getGithubInput)();
(0, get_version_1.default)({ packagePath, jsonPath }).then((version) => {
    if (version) {
        (0, helpers_1.setOutput)(version);
        (0, helpers_1.printVersion)(version);
    }
    else {
